...
export default function LoginPage() {
  return (
    <main style={{ maxWidth: 560, margin: "4rem auto", padding: "0 1.5rem" }}>
      <h1 style={{ fontSize: "1.5rem", marginBottom: "0.25rem" }}>Wagebook</h1>
      <p style={{ color: "var(--muted)", marginBottom: "2rem" }}>
        This is a demo login, not real authentication — pick a seeded persona to see the org as they would.{" "}
          ...
          <form key={persona.id} action={loginAsDemoPersona}>
            ...
            >
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
                ...
                <span style={{ color: "var(--muted)", fontSize: "0.8rem", textTransform: "uppercase" }}>{persona.role}</span>
              </div>
